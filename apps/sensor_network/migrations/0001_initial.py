    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ontology', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sensor_network', to='rdf_manager.Ontology')),
            ],
        ),
        migrations.CreateModel(
            name='Sensor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('event_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='sensor_network.Event')),
                ('function', models.CharField(choices=[('seq', 'seq'), ('seq_any', 'seq_any'), ('overlaps', 'overlaps'), ('any', 'any')], default='seq', max_length=10)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='sensor',
            name='sn',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sensor_network.Platform'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='cause',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cause_sensor', to='sensor_network.Sensor'),
        ),
    ]
